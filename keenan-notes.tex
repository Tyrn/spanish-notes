...
One of several options for "to happen" (see Chapter 11), pasar
is also usually safe for most uses of "to pass," although it's a bit slangy
at the dinner table (Pasame la sal). One use you may not be expecting:
in some Latin American countries, pasar is the verb to use when asking "what's on" television or at the local theater. iQue estan pasando
en el 8~ = "What's on ChannelS?" Estdn pasando la nueva pelicula
de de Niro en el Cine Co16n = "They're showing the new de Niro
movie at the Cine Colon." In South American countries the verb of
choice here would be dar, usually in the phrase estar dando.

As a colloquial greeting, both iQue pasa~ and iQue pas6~ are
used, though individual countries tend to have a preferred form. In
most situations, iQUe pasa~ implies that something is wrong or abnormal; this is the question to ask when there are police cars parked in
front of your house. In Mexico, where iQUe pas6~ is the preferred
greeting, saluting someone with iQUe pasa~ may prompt raised eyebrows and the question iPor que~ So much for starting a pleasant
conversation.

Using pasar can conveys "to happen to" in the sense of "to
become of." iQue pas6 can Tuan~ = "What's become of Juan?"-that
is, why is he late? In the present tense iQue pasa~ with an indirect
object pronoun (me, te, ie, nos, or les) is like asking "What's (my, your,
his, her, our, their) problem?" In fact, iQUe te pasa~ is roughly equivalent to "What's bugging you?" In the past tense, this same construction means "What happened to (me, you, him, her, us, them)?II: iQue
le pas6~ = "What happened to him?"-for example, why are they carrying him off on a stretcher?

Pasarse, the reflexive form, plus the preposition de is very
handy in expressions meaning "to go too far," figuratively speaking. Se
pas6 de listo means someone "was too cleverII or "was too sneaky,"
and implies that the person got caught at it. Sometimes it can be translated as lito get carried away.II When a person se pasa de listo (lista)
with another person, it can mean that he or she is making unwelcome
sexual advances. Ese senor se pas6 de listo can Marfa = "That guy
made a (rude) pass at Maria." The formula pasarse de can be used with
almost any adjective or quality, positive or negative. Usted se pasa de
generosa = "You are being overly generous. II Te pasaste de imbecil =
"You were even stupider than usual."

\section{\emph{pedir}}

liTo ask," lito ask for," and the correct verb for lito orderII in
a restaurant (although ordenar is gaining ground). Pedir should make
you think of indirect commands and the subjunctive: Pidele que se
vaya ("Ask him to leave"). It is also used in a number of stock phrases,
quite a few of which you are liable to need in the course of your dealings in Spanish. Some common ones include pedir permiso (lito ask
permission"), pedir perd6n (lito apologize"), pedir in/ormes (lito ask for
information"), and pedir ayuda (lito ask for help"). Pedir prestado is
the correct phrase for "to borrow," but you'll often find prestar (see below) handier. A rule of life for some in the Spanish-speaking world is
Es mds fdcil pedir perd6n que pedir permiso, or "It's easier to ask forgiveness than permission."

\section{\emph{pensar}}

The verb for "to think," though often creer (see above) is preferred. To the extent that there is a rule for distinguishing them, use
pensar when you might use "to have been thinking" or "to be thinking
about" in English. If it's just a simple statement of opinion, use creer.
Pienso que debes irte == "It is my feeling that you should go." Greo
que debes irte == "You should probably go." Sometimes the two are
interchangeable. A usage of pensar you should become very familiar
with is pensar plus the infinitive to mean "to plan on" or "to intend."
Pienso irme manana == "I plan to go tomorrow." Pienso quedarme
unos dias == "I intend to stay a couple of days." Pensar + en is "to
think of" or "to have in mind." Pensar + sabre (or acerca de) works as
"to think about" or "to consider" something. Pensar + de is "to think
of," in the sense of an opinion, and is a lot like creer. Estoy pensando
en nuestras vacaciones == "I'm thinking of (remembering, daydreaming about) our vacation." Todavia estoy pensando sabre (or acerca de)
nuestras vacaciones == "I'm still thinking about (considering, analyzing) our vacation." iQue piensas de nuestras vacaciones? = "What do
you think of our vacation (so far)? Stock phrases with pensar include
;ni pensarlo! ("no way," "it's out of the question"), pensdndolo bien
("on second thought"), and sin pensar ("without thinking,"
"unintentionally").
