...
called \emph{cremas}, as in cmma de champiiiones ("cream of mushroom
soup"). "Soap" is ;abon.

\section{\emph{soportar}}

%SOPORTAR
A common word in Spanish for "to tolerate,lt
though it is more frequent in the negative in the sense of "can't stand."
No soporto la television = "I can't stand television." Mixing it up will
get you some funny looks: Mi familia me soporta doesn't mean your
family pays your bills but that your family tolerates you (barely). For
"to support" in the bill-paying sense use mantener. In the sense of
physically supporting something (what a wall does for the ceiling, in
other words), sostener is more accurate.

\section{\emph{sumar}}

%SUMAR
This verb may pop into your mind as a neat translation for "to sum up," but you should pop it right back out of there if
you want to be understood. Sumar is the word for "to add" or "to add
up." iCuanto suma/ = "How much does that add up to?" For summaries and summations, stick to the verb resumir (para resumir = "to
sum up," en resumen = "in sum"), although en suma is safe for "in
sum" as well.
...
"to substitute" or "to fill in for." Suplo en la oficina ami hermana
cuando esta de via;e = "I fill in for my sister at the office when she's
out of town." A suplente is a "substitute"-a substitute teacher, for
instance. Substituto and substituir also exist and mean about the
same thing, but suplir and its derivatives are more frequent (and far
easier to pronounce).
...
it seems. Es un niiio tremendo describes a monstrous child capable of
...
the fruit of the prickly pear cactus, or nopal-that is, the "prickly
pear" itself. "Tuna" is atun. Both are perfectly edible, but if you have
...
%ÚLTIMAMENTE
In correct usage not "ultimately" but "recently." Ultimamente ha estado enferma = "She's been sick of late."
For "ultimately," use al final or a fin de cuentas. A fin de cuentas, es
su decision = "Ultimately it is his decision."
...
good cognate for this usage. To express "vague," use vago, carefully,
and use impreciso when referring to people or when there's any chance
...
example of this than the Spanish word zona, or "fox" (Le., a canine
...
tricksters than to get a slap in the face? If you must use corny comeons, stick to guapo and guapa.
